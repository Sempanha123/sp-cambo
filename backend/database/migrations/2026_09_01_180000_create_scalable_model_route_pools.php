...
return new class extends Migration
{
    ...
    {
        /*
         * R4 upgrades the earlier route-pool schema instead of creating the same
         * tables a second time. This keeps fresh installs and existing databases
         * on one migration path.
         */
        ...
        /*
         * Backfill entries created by the first route-pool migration. The public
         * alias already points at a primary private model, so legacy rows can be
         * upgraded deterministically without exposing or inventing a provider.
         */
