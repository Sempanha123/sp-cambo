...
class TelegramPurchase extends Model
{
    ...
    public function fulfillmentClaim(): BelongsTo { return $this->belongsTo(FulfillmentClaim::class); }
    public function apiKey(): BelongsTo { return $this->belongsTo(ApiKey::class); }
}
