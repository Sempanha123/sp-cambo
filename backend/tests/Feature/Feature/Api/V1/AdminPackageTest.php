...
class AdminPackageTest extends TestCase
{
    ...
    private function pricedAlias(int $upstreamCost): ModelAlias
    {
        ...
        $alias = ModelAlias::query()->create(['ai_model_id' => $model->id, 'public_alias' => 'claude-coding', 'display_name' => 'Claude Coding', 'capabilities' => [], 'limits' => [], 'status' => 'available', 'enabled' => true, 'customer_visible' => true]);
