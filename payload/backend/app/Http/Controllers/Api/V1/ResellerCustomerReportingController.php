    ...
    public function allocations(Request $request, string $resellerCustomer): JsonResponse
    {
        ...
        return response()->json([
            'data' => $rows->map(function (ResellerTransfer $transfer) use (
                ...
                $display = $target === null
                    ? null
                    : SpCredits::displayLot(
                        $target,
                        (int) $transfer->units,
                        [
                            'original_units' => $customerOriginal,
                            'remaining_units' => $customerRemaining,
                            'reserved_units' => $customerReserved,
                        ]
                    );
                ...
                return [
                    ...
                    'package_name' => $target?->package_name === null
                        ? null
                        : SpCredits::cleanLabel((string) $target->package_name),
