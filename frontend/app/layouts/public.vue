...
<template>
  <div class="sp-r4-layout sp-r4-public-layout sp-r12-layout sp-r12-public-layout sp-shell-aurora flex min-h-screen flex-col">
    ...
    >
      ...
      <template #right>
        <!-- Desktop header actions intentionally use NuxtLink instead of UButton.
             This keeps them compact and prevents the global button skin from
             forcing the labels onto two lines in the public header. -->
      ...
      <template #body>
        <div class="sp-r4-mobile-menu space-y-5">
          <UNavigationMenu
            :items="publicLinks"
    ...
    <main class="sp-r4-main relative z-[1] flex-1">
      <slot />
    </main>
